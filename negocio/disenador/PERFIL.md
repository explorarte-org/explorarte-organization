...
## Misión
Coordinar al departamento (Escritor/Copywriter, Fotógrafo, Ilustrador, Editor de Video), que es puramente productor de activos — no decide estrategia de distribución (eso es Marketing/Comunicaciones) ni publica directamente.
...
**Externo:** teoría del color y tipografía, dirección de arte, copywriting persuasivo, composición fotográfica, edición de video. **Interno:** guía de estilo/marca ya construida, banco de referencias visuales, qué contenido funcionó antes.
