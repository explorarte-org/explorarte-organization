...
## Misión
Coordinar al departamento (Investigador del Consumidor, Analista de Performance) y definir la estrategia de crecimiento — no ejecuta campañas él mismo, prioriza y decide qué se prueba.
...
**Externo:** psicología del consumidor, economía conductual, growth marketing, pricing psychology, colores del consumo (psicología del color aplicada a venta), técnicas de atención inmediata, neuromarketing. **Interno:** resultados de campañas pasadas, pricing histórico, perfiles de consumidor ya construidos.
