...
BEGIN
    ...
    IF NEW.reviewed_at IS NOT NULL AND NEW.reviewed_at > NEW.updated_at THEN RAISE EXCEPTION 'organizational memory reviewed_at cannot follow updated_at' USING ERRCODE = '23514'; END IF;
    RETURN NEW;
END;
$$;
