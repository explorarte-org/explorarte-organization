...
func TestMigration78CampaignOwnerApprovalsForwardBackForward(t *testing.T) {
	...
	var migration78 platformmigrations.Migration
	...
	if !tableExists("campaign_owner_approvals") {
		t.Fatal("campaign_owner_approvals table must exist after up")
	}
	...
	if tableExists("campaign_owner_approvals") {
		t.Fatal("campaign_owner_approvals table must NOT exist after down")
	}
	...
	if !tableExists("campaign_owner_approvals") {
		t.Fatal("campaign_owner_approvals table must exist again after second up")
	}
}
