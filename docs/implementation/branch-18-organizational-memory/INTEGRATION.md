...
- Rama de trabajo: `rebase/18-organizational-memory-on-r17`.
...
Rama 17 dejó el tip global en `14`; Rama 18 lo eleva a `15`. Existen suites legacy que históricamente han hardcodeado el tip global. El worker debe localizar todas las que sigan representando **el tip global actual** y cambiarlas de 14 a 15.
